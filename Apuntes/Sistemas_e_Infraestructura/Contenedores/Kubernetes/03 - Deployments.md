...
---
# Definición
Un deployment é un recurso de [[Apuntes/Sistemas_e_Infraestructura/Contenedores/Kubernetes/01 - Introducción#Qué é?|Kubernetes]] que nos permite definir o estado deseado da aplicación, e deixar que Kubernetes se encargue de levala ao estado automáticamente. Un deployment asegurase de que o número desexado de réplicas dunha aplicación esté en funcionamento.
