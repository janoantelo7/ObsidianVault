...
Podemos utilizar `kubectl exec` para executar comandos dentro dos [[Apuntes/Sistemas_e_Infraestructura/Contenedores/Kubernetes/01 - Introducción#Componentes|pods]].
```bash
