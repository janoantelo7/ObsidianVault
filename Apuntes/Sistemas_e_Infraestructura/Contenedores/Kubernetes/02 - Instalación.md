...
tags:
  - kubernetes
---
En esta guía recollense os comandos necesarios para poder realizar a instalación de un clúster de  [[Apuntes/Sistemas_e_Infraestructura/Contenedores/Kubernetes/01 - Introducción#Qué é?|Kubernetes]] en Ubuntu.
...
Inicializamos o cluster de kubernetes no **[[Apuntes/Sistemas_e_Infraestructura/Contenedores/Kubernetes/01 - Introducción#Componentes|nodo controlador]]**.
```bash
...
No nodo controlador creamos o token e copiamos o comando de kubeadm join. Este comando vainos mostrar o comando "kubeadm join" que é o que debemos utilizar nos [[Apuntes/Sistemas_e_Infraestructura/Contenedores/Kubernetes/01 - Introducción#Componentes|nodos]].
```bash
