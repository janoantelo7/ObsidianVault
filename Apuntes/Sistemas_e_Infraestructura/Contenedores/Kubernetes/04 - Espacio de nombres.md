...
Buscar os [[Apuntes/Sistemas_e_Infraestructura/Contenedores/Kubernetes/01 - Introducción|pods]] en todos os namespaces
```bash
kubeclt get pods --all-namesapces
```

Buscar os [[Apuntes/Sistemas_e_Infraestructura/Contenedores/Kubernetes/01 - Introducción|pods]] solo no espacio que nos interesa
```bash
