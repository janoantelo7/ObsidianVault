...
---
# Contenedores
Crear e ejecutar un [[Apuntes/Sistemas_e_Infraestructura/Contenedores/Docker/01 - Introducción#Contenedor|contenedor]] con un nombre personalizado.
```bash
...
```
# Imágenes
Construir unha [[Apuntes/Sistemas_e_Infraestructura/Contenedores/Docker/01 - Introducción#Imágen|imagen]] desde un [[Apuntes/Sistemas_e_Infraestructura/Contenedores/Docker/01 - Introducción#Dockerfile|Dockerfile]].
```bash
...
```
# Volúmenes
Crear un [[Apuntes/Sistemas_e_Infraestructura/Contenedores/Docker/01 - Introducción#Volumen|volumen]].
```bash
...
```
# Sistema
Mostrar o uso de disco de [[Apuntes/Sistemas_e_Infraestructura/Contenedores/Docker/01 - Introducción#Qué é?|Docker]].
```bash
docker df
```
