...
| ----------------------------------------------------------- | ---------------------- |
| [[01 - Introducción a Linux#Instalar paquetes\|Arch Linxu]]    | `pacman -S tmux`       |
| [[01 - Introducción a Linux#Instalar paquetes\|Debian/Ubuntu]] | `apt install tmux`     |
| [[01 - Introducción a Linux#Instalar paquetes\|Fedora]]        | `dnf install tmux`     |
| [[01 - Introducción a Linux#Instalar paquetes\|RHEL]]          | `dnf install tmux`     |
