...
```
# Zip
Esta ferramenta utilizamola para traballar con ficheros `.zip`. Con ela podemos comprimir e descomprimir ficheros. É moi útil cando traballamos con ficheros entre Linux e Windows xa que funciona nos dous sistemas. Polo general en Linux non suele vir preinstalada esta ferramenta polo que a deberemos instalar co [[01 - Introducción a Linux#Gestión de paquetes|xestor de paquetes]] da nosa distrubución.
## Comprimir un fichero
