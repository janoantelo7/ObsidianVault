...
- Para facer ejecutable o noso script temos que darlle [[01 - Introducción a Linux#Permisos de ficheros/carpetas|permisos]] de execución ao fichero. Podemos facelo de maneira rápida con `chmod +x <nombre_script>`.
