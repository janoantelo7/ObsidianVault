...
Mediante o seguinte comando de [[02 - Azure CLI e Azure PowerShell#^75a6fc|Azure CLI]] podemos exportar un [[Apuntes/Sistemas_e_Infraestructura/Azure/01 - Administración de Azure/01 - Introducción#Qué son os resource groups?|resource group]] a un fichero `.json` de ARM Template.
```bash
