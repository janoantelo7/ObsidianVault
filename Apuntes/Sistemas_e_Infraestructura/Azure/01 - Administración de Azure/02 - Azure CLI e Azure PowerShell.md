...
Creamos a máquina virtual dentro de ese [[Apuntes/Sistemas_e_Infraestructura/Azure/01 - Administración de Azure/01 - Introducción#Qué son os resource groups?|resource group]], co nombre do usuario que lanzou o comando e para **conectarnos** mediante **claves ssh**.
```bash
