...
- Movelos
# Tags
Os _tags_ son pares clave-valor que se utilizan para organizar recursos. O que significa que temos un nombre e un valor. As etiquetas podense **asignar** a case **calquer cousa** en Azure. Podense agregar a [[Apuntes/Sistemas_e_Infraestructura/Azure/01 - Administración de Azure/01 - Introducción#Qué son as suscripcións?|suscripcións]], [[Apuntes/Sistemas_e_Infraestructura/Azure/01 - Administración de Azure/01 - Introducción#Qué son os resource groups?|resource groups]], e [[Apuntes/Sistemas_e_Infraestructura/Azure/01 - Administración de Azure/01 - Introducción#Qué son os resources?|recursos]]. 
