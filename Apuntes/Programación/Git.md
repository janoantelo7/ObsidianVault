...
# Instalación de Git
Nas distribucións de Linux, Git debería estar nos repositorios do sistema. Por ejemplo, en Debian podemos [[01 - Introducción a Linux#Instalar paquetes|instalalo]] da seguinte maneira:
```bash
