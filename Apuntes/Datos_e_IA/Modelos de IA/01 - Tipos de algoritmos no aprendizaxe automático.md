...
---
# Introducción
Existen principalmente, tres tipos de aprendizaxe automático: supervisado, non supervisado e por reforzo. Estos son os tres grandes paradigmas do [[00 - Introducción ao Machine Learning#Machine Learning|machine learning]]. A principal diferenza entre eles radica en que tipo de información recibe o modelo durante o entrenamento e cómo aprende.
