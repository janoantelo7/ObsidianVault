...
- [[Apuntes/Servicios/Bases de datos/Mongodb/01 - Introducción|MongoDB]]
- Apache CouchDB
## Clave-valor
...
- Tratamento de erros
## Big Data e NoSQL
As bases de datos NoSQL e o Big Data están moi relacionados, xa que NoSQL grazas á flexibilidade que ofrece para almacenar distintas tipoloxías de datos o non empregar un esquema fijo da solución a moitos dos problemas cando tratamos con datos catalogados como Big Data:
